...
public class Professor {
	...
	public static Professor obterProfessor(String nome, String matricula, String email) throws DadosProfessorIncompletosException {
		...
		if (nome == null || nome.equalsIgnoreCase("") ||
			...
			StringBuilder builder = mensagemProfessorIncompleto(nome, matricula, email);
	...
	private static StringBuilder mensagemProfessorIncompleto(String nome, String matricula, String email) {
